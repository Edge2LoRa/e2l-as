...
class GRPCDemoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SimpleMethodGWInfo = channel.unary_unary(
                ...
                request_serializer=demo__pb2.RequesGWInfo.SerializeToString,
                response_deserializer=demo__pb2.Gateway_info_list.FromString,
                _registered_method=True)
        self.SimpleMethodDevInfo = channel.unary_unary(
                '/demo.GRPCDemo/SimpleMethodDevInfo',
                request_serializer=demo__pb2.RequestDevInfo.SerializeToString,
                response_deserializer=demo__pb2.Device_info_list.FromString,
                _registered_method=True)
...
def add_GRPCDemoServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SimpleMethodGWInfo': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=demo__pb2.RequesGWInfo.FromString,
                    response_serializer=demo__pb2.Gateway_info_list.SerializeToString,
            ),
            'SimpleMethodDevInfo': grpc.unary_unary_rpc_method_handler(
                    servicer.SimpleMethodDevInfo,
                    request_deserializer=demo__pb2.RequestDevInfo.FromString,
                    response_serializer=demo__pb2.Device_info_list.SerializeToString,
            ),
    }
...
class GRPCDemo(object):
    ...
    def SimpleMethodGWInfo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/demo.GRPCDemo/SimpleMethodGWInfo',
            demo__pb2.RequesGWInfo.SerializeToString,
            demo__pb2.Gateway_info_list.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SimpleMethodDevInfo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/demo.GRPCDemo/SimpleMethodDevInfo',
            demo__pb2.RequestDevInfo.SerializeToString,
            demo__pb2.Device_info_list.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
