...
import edge2applicationserver_pb2 as edge2applicationserver__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in edge2applicationserver_pb2_grpc.py depends on'
...
def add_Edge2ApplicationServerServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('edge2applicationserver.Edge2ApplicationServer', rpc_method_handlers)
