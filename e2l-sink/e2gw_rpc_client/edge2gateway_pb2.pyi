...
class Device(_message.Message):
    __slots__ = ("dev_eui", "dev_addr", "assigned_gw", "edge_s_enc_key", "edge_s_int_key")
    DEV_EUI_FIELD_NUMBER: _ClassVar[int]
    DEV_ADDR_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, dev_eui: _Optional[str] = ..., dev_addr: _Optional[str] = ..., assigned_gw: _Optional[str] = ..., edge_s_enc_key: _Optional[bytes] = ..., edge_s_int_key: _Optional[bytes] = ...) -> None: ...
